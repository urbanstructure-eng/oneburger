...
/**
 * Uber Eats official brand logo in monochrome white
 */
...
/**
 * SkipTheDishes official brand logo in monochrome white
 */
export const SkipTheDishesLogoWhite: React.FC<{ className?: string }> = ({ className = 'h-5 w-auto' }) => (
  ...
  >
    {/* Stylized Fork & Spoon Icon in white */}
    <g transform="translate(1, 2)">
      <circle cx="11" cy="11" r="10" stroke="#FFFFFF" strokeWidth="1.8" fill="none" />
      {/* Fork prongs and spoon cross in white */}
      <path
